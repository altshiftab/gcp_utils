...
func MakeBareEndpoints(options ...path_config.Option) *types.EndpointSpecificationOverview {
	...
	tokenEndpointSpecification := &endpoint_specification.EndpointSpecification{
		...
		HeaderParserConfiguration: &parsing.HeaderParserConfiguration{Parser: nil},
...
func PopulateBareEndpoints(
	...
	loginEndpointSpecification.UrlParserConfiguration = &parsing.UrlParserConfiguration{Parser: requestParserAdapter.New(redirectUrlRequestParser)}
