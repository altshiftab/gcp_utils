module github.com/altshiftab/gcp_utils/pkg/http/login/sso

go 1.25

require (
	github.com/Motmedel/utils_go v0.0.363
	github.com/Motmedel/utils_go/pkg/http/mux v0.0.153
	...
	github.com/altshiftab/gcp_utils/pkg/http/login v0.0.26
...
require (
	...
	github.com/Motmedel/utils_go/pkg/http/types/problem_detail v1.0.8 // indirect
