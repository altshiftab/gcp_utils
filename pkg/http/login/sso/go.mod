...
require (
	github.com/Motmedel/utils_go v0.0.366
	github.com/Motmedel/utils_go/pkg/http/mux v0.0.154
	github.com/Motmedel/utils_go/pkg/http/mux/types/body_parser/json_schema_body_parser v0.0.16
	...
	github.com/altshiftab/gcp_utils/pkg/http/login v0.0.34
